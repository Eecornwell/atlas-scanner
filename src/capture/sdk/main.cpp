...
// at the configured interval, download the .insp immediately via the URL
// returned by TakePhoto(), and write a shutter_event file for each shot.
// This is identical to stationary mode but repeated on a timer.
//
            ...
            timer_thread = std::thread([&]() {
                ...
                while (!timer_stop.load()) {
                    ...
                    if (ok) {
                        ...
                        LOG_ERR("[continuous] download failed: " << sanitise(remote_path));
                    }
